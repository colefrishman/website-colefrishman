	...
	return(
		<div style={{marginRight: "10%", marginLeft: "10%", marginTop:"2%"}}>
            ...
            <Slider {...sliderProps} style={{height:"350px"}}>
                ...
                <ContentCard title="LinkedIn"       src="https://www.linkedin.com/in/cole-frishman-229952180/"          image="/logos/linkedin.png"   text="See all map design content."       linktext="Go to my profile"/>
                <ContentCard title="GitHub"         src="https://github.com/colefrishman"                               image="/logos/github.png"     text="See all map design content."       linktext="Go to my page"/>
                <ContentCard title="Google Play"    src="https://play.google.com/store/apps/developer?id=Cole+Frishman" image="/logos/playstore.png"  text="See all graphic design content."   linktext="Go to my page"/>
                <ContentCard title="Npm"            src="https://www.npmjs.com/~colefrishman"                           image="/logos/npm.png"        text="See all sports design content."     linktext="Go to my page"/>
