	...
	return(
		<div style={{marginRight: "10%", marginLeft: "10%", marginTop:"2%"}}>
			...
			<Slider {...sliderProps} style={{marginBottom:"100px"}}>
				...
				<ContentCard title="Football"			src="/sports#football"			image="https://www.publicdomainpictures.net/pictures/80000/velka/football-ball.jpg"		text="See all football content."											linktext="View Gallery"/>
				<ContentCard title="Baseball"			src="/sports#baseball"			image="https://www.publicdomainpictures.net/pictures/70000/velka/baseball-ball.jpg"		text="See all baseball content."											linktext="View Gallery"/>
			</Slider>
