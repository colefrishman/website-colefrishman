...
const OldHome = () => {
	return(
		<div style={{marginRight: "10%", marginLeft: "10%", marginTop:"2%"}}>
			...
			<ul>
			<li><a href="/whensmelee">When's Melee</a> is a tool that you can use to find upcoming tournaments for the video game <a href="https://en.wikipedia.org/wiki/Super_Smash_Bros._Melee#Professional_competition"> Super Smash Bros. Melee.</a> The results are automatic, and pull data from <a href="https://start.gg">Start.gg</a></li>
				<li><a href="https://us-map-maker.herokuapp.com">U.S. map maker</a> (in progress) lets you create maps of the U.S. quickly.</li>
				...
				<li>I also have some <a href="/sports">sports stuff</a></li> 
